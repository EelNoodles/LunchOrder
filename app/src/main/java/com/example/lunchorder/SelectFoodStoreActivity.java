...
import com.example.lunchorder.AdminDateMenuActivity;
import com.google.firebase.database.ValueEventListener;

public class SelectFoodStoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_food_store);

        FoodRef = FirebaseDatabase.getInstance().getReference().child("Store").child("FoodStore");
        recyclerview = findViewById(R.id.SelectFoodStoreActivityRecycleMenu);
    ...
    protected void onStart(){
        ...
        final FirebaseRecyclerAdapter<Food, FoodViewHolder> adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder holder, int position, @NonNull final Food model) {
                ...
                holder.DisplaySelectFoodStoreName.setText(model.getStoreName());

                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        Intent intent = new Intent(SelectFoodStoreActivity.this, AdminRemoveFood.class);
