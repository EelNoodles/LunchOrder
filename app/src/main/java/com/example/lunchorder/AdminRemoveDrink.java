...
public class AdminRemoveDrink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_remove_drink);

        FoodStore = getIntent().getStringExtra("FoodStore");

        FoodRef = FirebaseDatabase.getInstance().getReference().child("Food").child("Drink").child(FoodStore);
        recyclerview = findViewById(R.id.RemoveDrinkActivityRecycleMenu);
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder holder, int position, @NonNull final Food model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(AdminRemoveDrink.this);
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(i == 0){
                                    ...
                                    RootRef.child("Food").child("Drink").child(FoodStore).child(model.getFood()).removeValue();
